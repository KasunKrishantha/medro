            ...
            <div class="col-md-4">
              <div class="card" style="padding:0; margin:0; box-shadow: 0 15px 20px rgba(0, 0, 0, 1);">
                <div class="card-header">
                  <img src="<?php echo base_url('assets/img/check.png'); ?>" alt="" style="width: 50px;">
                  <h5 style="color: black; margin-top: 10px;">Email sent successfully</h5>
                </div>
                <div class="card-body">
                  <p>Use the link in the email to reset password</p>
                </div>
              </div>
            </div>
          </div>
