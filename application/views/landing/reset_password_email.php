            ...
            <div class="col-md-4">
              <div class="card" style="padding:0; margin:0; box-shadow: 0 15px 20px rgba(0, 0, 0, 1);">
                <div class="card-header">
                  <h5 style="color: black;">Please enter your email to send password reset link</h5>
                </div>
                <div class="card-body">
                  <?php echo form_open('auth/email_reset_password', 'class="form-signin" id="myform" style="padding: 2em 0 2em 0;"'); ?>
