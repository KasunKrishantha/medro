      ...
      <div class="container">
        <div class="intro-text">
          <div class="row justify-content-md-around">
            <div class="col-md-5">
              <p id="intro-dental">Specialty Dental Clinic in Colombo for Immediate Loading Basal Implants, Smile Designing, Laser Dentistry & Correction of Dento-facial Trauma & Deformities.</p>
            </div>
            <div class="col-md-4">
              <div class="card" style="box-shadow: 0 15px 20px rgba(0, 0, 0, 1); ">
                <div class="card-body">
                  ...
                  <div>
                    ...
                    <p>Forgot your password? <a style="" href="<?php echo site_url('auth/enter_reset_password_email'); ?>">Reset Password</a></p>
                  </div>
                </div>
              </div>
            </div>
